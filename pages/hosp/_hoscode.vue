  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      ...
      <div class="nav-item selected">
        ...
        :onclick="'javascript:window.location=\'/hosp/'+hospital.hoscode+'\''"> 预约挂号
        </span>
      </div>
        ...
        <div class="info-wrapper">
          ...
          <div class="content-wrapper">
            ...
            <div class="inline">
              ...
              <span v-if="bookingRule.quitDay == -1">就诊前一个工作日{{ bookingRule.quitTime }}前取消</span>
